...
> Tidy UI and content updates — added IDs and icons, adjusted footer and home link, added admission/campus‑life/academics icons, corrected the research/career link and handled some bot-related housekeeping.->
...
> Maintained sdm660-common by updating blobs and Bluetooth, adjusting SELinux/build modes (enforcing/permissive), disabling blur by default, skipping Device Doze/Settings builds, moving to a standalone extraction script, and migrating to 4.14 HALs.->
...
> Improved lavender device configs: removed SysUI from dexopt apps, enabled proximity checks for DT2W, updated media profiles/codecs, added Wi‑Fi options and fsverity support, removed ese power manager, and built AntHalService.->
...
> Applied sdm660-common updates to lavender: DT2W proximity checks, media profile and codec updates, Wi‑Fi options, fsverity and AntHalService additions, switched overlays to RRO, and updated GPS blobs.->
...
> Refined vendor board/vendor configs — fixed BoardConfigQcom issues, enabled sdm660 DRM_PP and master-side CP support, initialized board variables correctly, refactored GMS client ID handling, and enabled dexpreopt for SystemUIGoogle.->
...
> Similar vendor improvements: resolved BoardConfigQcom problems, added sdm660 DRM_PP and master CP support, refactored GMS client ID logic, and enabled SystemUIGoogle dexpreopt.->
...
> Fixed and improved BoardConfigQcom and vendor settings, added sdm660 DRM_PP/master CP support, refactored GMS client ID handling, and enabled dexpreopt for SystemUIGoogle.->
...
> Updated vendor configs to fix BoardConfigQcom issues, add sdm660 DRM_PP and master CP support, refactor GMS client ID handling, and shift SystemUI to SystemUIGoogle dexpreopt.->
...
> Polished jasmine_sprout device: pixelized and standardized branding, excluded TWRP from builds, added battery capacity, reverted to stock screen density, and removed the custom build description.->
...
> No commit messages available to summarize.->
...
> Merged several PRs, added dependabot configuration, and integrated a copilot-code-review-runner and related CI updates.->
...
> Updated msm8996-common with carrier, filesystem, security configs and refreshed media codecs from the LA.UM.9.6.3 release.->
...
> Adjusted sepolicy for legacy devices and vendor integration: added c2 rules, avoided calling PE’s sepolicy directly, fixed PE paths, and removed vendor prefix from lmkd.->
...
> Merged multiple Android 11 hardware/interfaces release tags to keep the tree synchronized with upstream releases.->
...
> Merged PRs, refactored the gallery search query builder, and added dependabot automation.->
...
> Synced upstream sepolicy tags, removed vbmeta/dtbo dev/block paths, and adapted policy paths for Legion.->
...
> Merged PRs and added dependabot configuration to keep dependencies up to date.->
...
> Enabled proximity checks for DT2W (including wake behavior) and migrated lavender overlays to RRO.->
...
> Enabled Camera2 API for legacy targets and fixed the camera interface handling for ViLTE calls on sm6150-common.->
...
> Applied the same QCOM common tweaks: inherit board Bluetooth configs earlier and conditionally set telephony advancedscan for legacy platforms.->
...
> Refactored GMS client ID setup and migrated SystemUI to SystemUIGoogle.->
...
> Enabled Camera2 API for legacy targets and fixed the camera interface for ViLTE on sm6150-common.->
