...
> Updated site navigation and footer—added icons, links and IDs for sections and applied minor bot-related tweaks.->
...
> Refreshed sdm660 common with updated vendor blobs, adjusted SELinux/build permissiveness, disabled blur by default, and switched extraction/HALs.->
...
> Tuned lavender device: enabled DT2W proximity checks, updated media/wifi configs, removed ESE power manager, and added build flags/services.->
...
> Fixed BoardConfigQcom issues, added sdm660 DRM and master-side support, and refactored GMS/SystemUI preopting.->
...
> Implemented BoardConfigQcom fixes, enabled sdm660 DRM support, and refactored vendor GMS/SystemUI preoptimizations.->
...
> Applied BoardConfigQcom corrections, enabled sdm660 DRM_PP and vendor GMS/SystemUI refactors.->
...
> Fixed BoardConfigQcom, added sdm660 DRM/master support, and refactored vendor GMS and SystemUI handling.->
...
> Cleaned jasmine_sprout device config by updating branding, screen density, battery capacity, and build settings.->
...
> Updated dependencies via dependabot and added dependabot configuration for maintenance.->
...
> Integrated CI and dependency updates, added Copilot code-review runner and dependabot configuration.->
...
> Applied dependency updates and added dependabot configuration for Partytown.->
...
> Updated MSM8996 common with refreshed carrier, filesystem, security settings, and media codecs from upstream.->
...
> Adjusted qcom sepolicy for legacy devices, fixed vendor/PE paths, and simplified lmkd labeling.->
...
> Synced hardware_interfaces with Android 11 release tags.->
...
> Synced sepolicy with upstream LA.UM tags and removed device block entries for Legion compatibility.->
...
> Restored telephony injection, added audio build components, and fixed camera interface for ViLTE.->
...
> Added Copilot code-review runner and dependabot configuration.->
...
> Inherited board configs before product configs and conditionally set telephony props for legacy targets.->
...
> Refactored PRODUCT_GMS_CLIENTID_BASE handling and migrated SystemUI to SystemUIGoogle.->
...
> Switched to a dynamic changelog and fixed assorted updater issues.->
...
> Enabled Camera2API and corrected ViLTE camera properties for sm6150 targets.->
