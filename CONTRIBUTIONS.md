...
> Hardened builds and SELinux handling, updated many proprietary blobs (Bluetooth, GPS), disabled blur by default, switched to 4.14 HALs, added extraction tooling and toggled temporary permissive build settings.->
...
> Refined lavender device trees and common sdm660 pieces: removed SysUI from dexopt, enabled proximity checks for DT2W, updated codecs/media profiles, added wifi options, GC tweaks, removed ESE power manager, built AntHalService and enabled fsverity flag.->
...
> Applied sdm660-common improvements to lavender: codec/profile updates, RRO overlay migration, wifi tweaks, removed ESE power manager, AntHalService build, fsverity userdata flag, and GPS blob updates.->
...
> Fixed BoardConfigQcom issues and initialization order, added sdm660 DRM_PP and master-side CP support, refactored GMS client ID handling, and adjusted dexpreopt for SystemUIGoogle.->
...
> Fixed BoardConfigQcom duplication and initialization, enabled sdm660 DRM_PP/master CP support, refactored PRODUCT_GMS_CLIENTID_BASE handling, and updated SystemUIGoogle dexpreopt.->
...
> Addressed BoardConfigQcom duplicate/MCP issues, enabled sdm660 DRM_PP/master CP support, refactored GMS client ID config, and updated SystemUIGoogle dexpreopt.->
...
> Polished jasmine_sprout device config: applied Pixel-style branding, capitalized PRODUCT_BRAND, removed TWRP build, set battery capacity and stock screen density, and cleaned build description.->
...
> Kept dependencies up to date and added Dependabot config by merging several Dependabot pull requests for dotenv, faker, Playwright Test and related packages.->
...
> Integrated Copilot code-review CI, merged multiple Dependabot updates, and added Dependabot configuration to keep dependencies and actions current.->
...
> Updated multiple npm/yarn dependencies via Dependabot (simple-git, partytown, wordpress/env) and added Dependabot configuration.->
...
> Updated msm8996-common carrier, config.fs, sec config, and media codecs from LA.UM.9.6.3 vendor sources.->
...
> Added c2 sepolicy for legacy devices, adjusted vendor sepolicy calls and PE paths, and removed vendor prefix from lmkd rules.->
...
> Merged several Android 11 hardware/interfaces release tags to keep platform hardware interfaces up to date with upstream android-11.x releases.->
...
> Refactored gallery search query building, integrated Copilot code-review runner, and added Dependabot configuration via merged PRs.->
...
> Merged Qualcomm LA.UM sepolicy tags, removed vbmeta/dtbo dev/block paths, and adapted sepolicy paths for Legion builds.->
...
> Switched rendering backend to OpenGL and cleaned up graphics properties for RMX1801.->
...
> Built audio components from source (libssrec, tinymix), restored telephony injection, and fixed camera interface properties for ViLTE calls.->
...
> Enabled and refined DT2W proximity checks and migrated overlays to RRO for lavender.->
...
> Enabled Camera2 API for legacy targets and fixed camera interface props for ViLTE on sm6150-common.->
...
> Improved Bluetooth configuration inheritance and conditionally set telephony advancedscan property for legacy platforms.->
...
> Applied same Bluetooth board inheritance and conditional telephony advancedscan prop adjustments for legacy boards.->
...
> Refactored GMS client ID configuration and migrated SystemUI to SystemUIGoogle in vendor layer.->
...
> Switched updater to dynamic changelog generation and fixed miscellaneous issues.->
...
> Enabled Camera2 API for legacy sm6150 targets and fixed camera interface props for ViLTE calls.->
