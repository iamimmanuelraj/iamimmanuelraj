...
> Updated UI and navigation: tweaked footer and bot-related bits, added home link and IDs, and added/updated icons for admission, campus life, academics while renaming career to research and linking it.->
...
> Maintained sdm660-common: refreshed blobs and HALs, adjusted SELinux/build policies (enforcing/permissive), disabled blur by default, updated Bluetooth blobs, pruned builds, and introduced a standalone extraction script.->
...
> Improved lavender device support: enabled DT2W proximity checks (including wake), optimized dexopt and media profiles, added wifi overlay options and fsverity, removed ESE power manager, and added AntHalService build support.->
...
> Synced sdm660-common improvements for lavender: media/profile updates, DT2W proximity checks, wifi overlay support, switched overlays to RRO, added fsverity and AntHalService, and updated GPS blobs.->
...
> Hardened vendor platform tooling: fixed BoardConfigQcom issues, enabled sdm660 DRM_PP and master-side CP support, initialized board vars correctly, refactored GMS client ID handling, and moved SystemUI dexpreopt to SystemUIGoogle.->
...
> Applied vendor platform fixes: corrected BoardConfigQcom behavior, enabled sdm660 DRM_PP and master-side CP, refactored GMS client ID logic, and adjusted SystemUI dexpreopt handling.->
...
> Implemented vendor fixes and enhancements: resolved BoardConfigQcom duplicate/MCP issues, enabled sdm660 DRM_PP and master CP support, refactored GMS client ID, and updated SystemUI dexpreopt behavior.->
...
> Updated vendor platform: fixed BoardConfigQcom issues, enabled sdm660 DRM_PP and master-side CP, refactored GMS client ID setup, and moved SystemUI dexpreopt to SystemUIGoogle.->
...
> Refined jasmine_sprout device config: applied pixelization, standardized PRODUCT_BRAND casing and screen density to stock, added battery capacity, removed TWRP build and build description.->
...
> Performed maintenance: integrated Dependabot updates, added Copilot code-review runner, and merged various CI/dependency upgrades.->
...
> Updated msm8996-common with refreshed carrier, fs and security configs plus updated media codecs from LA.UM vendor releases.->
...
> Improved qcom sepolicy: added c2 rules for legacy devices, fixed PE paths, removed vendor prefixes and adjusted lmkd/vendor handling.->
...
> No commits provided; nothing to summarize.->
...
> Added Copilot code-review runner, refactored the gallery search query logic, and applied Dependabot maintenance merges.->
...
> Merged upstream LA sepolicy tags and adapted paths for LegionOS, removing vbmeta/dtbo dev/block entries and aligning legacy sepolicy.->
...
> Switched RMX1801 to an OpenGL rendering backend and removed redundant graphic properties.->
...
> Enhanced jasmine sdm660-common: built libssrec and tinymix from source, restored telephony injection, and fixed camera interface props for ViLTE calls.->
...
> Merged Dependabot and added Copilot code-review runner for maintenance and CI improvements.->
...
> Enabled DT2W proximity checks (including wake) and migrated overlays to RRO for lavender device support.->
...
> Reordered Bluetooth config inheritance to use board configs first and conditionally set telephony advancedscan props for legacy platforms.->
...
> Adjusted qcom common behavior: inherited board BT configs before product configs and conditionally enabled telephony advancedscan on legacy platforms.->
...
> Added Dependabot configuration for automated dependency upgrades.->
...
> Refactored GMS PRODUCT_GMS_CLIENTID_BASE handling and switched vendor SystemUI references to SystemUIGoogle.->
...
> Switched updater to use a dynamic changelog and fixed assorted issues.->
