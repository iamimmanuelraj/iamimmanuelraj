...
> Updated site navigation and footer: added IDs, links and icons for Admission, Campus Life and Academics, replaced “career” with “research”, and applied some bot/housekeeping tweaks.->
...
> Maintained sdm660-common by updating blobs and HALs, adjusting SELinux/build permissiveness and policies, disabling blur by default, trimming unneeded Device Doze/Settings, and adding extraction/build scripts.->
...
> Improved lavender device support: enabled proximity checks for DT2W, updated media profiles/codecs, added Wi‑Fi options and fsverity support, removed unused services, and refined dexopt/build entries.->
...
> Applied sdm660-common improvements to lavender: media/profile updates, Wi‑Fi and fsverity additions, DT2W proximity checks, switched overlays to RRO, removed unused managers, and updated GPS blobs.->
...
> Refined vendor build logic: fixed BoardConfigQcom handling, enabled sdm660 DRM_PP and master-side CP support, refactored GMS client ID setting, and enabled dexpreopt for SystemUIGoogle.->
...
> Applied vendor/build fixes: stabilized BoardConfigQcom initialization, enabled sdm660 DRM_PP and master CP support, refactored GMS client ID handling, and enabled SystemUIGoogle dexpreopt.->
...
> Contributed BoardConfig and vendor tweaks: resolved MCP/duplicate platforms, enabled sdm660 DRM_PP, initialized board vars correctly, and refactored GMS/SystemUI dexpreopt behavior.->
...
> Implemented BoardConfig and vendor refinements: fixed duplicates, enabled sdm660 DRM_PP and master-side CP, and refactored GMS and SystemUIGoogle dexpreopt settings.->
...
> Polished jasmine_sprout device config: applied pixelization/branding tweaks, capitalized PRODUCT_BRAND, adjusted screen density and battery capacity, and removed TWRP/build description.->
...
> Applied dependency updates via Dependabot and added a Dependabot configuration to keep packages and actions current.->
...
> Merged Dependabot updates (dependencies and GitHub Actions) and added a Dependabot configuration to maintain CI and package hygiene.->
...
> Updated MSM8996 common configs and blobs: refreshed carrier, fs and security configs and media codecs from LA.UM.9.6.3 upstream.->
...
> Enhanced vendor sepolicy for legacy devices by adding c2 rules, correcting PE-related paths, and removing vendor prefixes from lmkd rules.->
...
> Synced the hardware/interfaces tree with multiple Android 11 release tags to keep upstream compatibility.->
...
> Merged upstream sdm660 sepolicy tags and adapted Legion paths, removing outdated vbmeta/dtbo dev/block entries.->
...
> Reworked sdm660-common: built audio components from source, restored telephony injection, and fixed the camera interface for ViLTE calls.->
...
> Refactored gallery search query building and added Dependabot configuration to keep dependencies current.->
...
> Enabled and refined DT2W proximity checks and migrated overlays to RRO for the lavender device.->
...
> Merged a series of Dependabot PRs to update test dependencies and GitHub Actions for CI stability.->
...
> Enabled Camera2 API for legacy sm6150 targets and fixed the camera interface behavior for ViLTE calls.->
...
> Applied the same qcom-common improvements: BT board config inheritance and conditional telephony advancedscan for legacy targets.->
...
> Refactored vendor GMS client ID handling and migrated SystemUI references to SystemUIGoogle in vendor configs.->
...
> Enabled Camera2 API for legacy sm6150 targets and corrected camera interface behavior for ViLTE calls.->
...
> Added Dependabot configuration to automate dependency updates and keep the repo secure.->
