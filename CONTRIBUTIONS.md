...
> Polished site navigation and UI: updated footers, added IDs and home link, and introduced icons for admission, campus life and academics while renaming/relinking career→research.->
...
> Maintained sdm660-common: enforced permissive builds temporarily, fixed SELinux denials, updated blobs (including Bluetooth), disabled blur by default, switched to 4.14 HALs and moved to a standalone extraction script.->
...
> Refined lavender device configs: removed SysUI from dexopt, added DT2W proximity checks, updated media profiles/codecs, added Wi‑Fi overlay support, removed ESE power manager, built AntHalService and enabled userdata fsverity.->
...
> Merged sdm660-common improvements for lavender: media/profile updates, DT2W proximity checks, Wi‑Fi support, AntHalService build, fsverity flag, switched overlays to RRO and updated GPS blobs.->
...
> Hardened vendor layer: fixed BoardConfigQcom issues, enabled sdm660 DRM_PP and master-side CP support, initialized board variables correctly, refactored GMS client ID handling and dexpreopt'd SystemUIGoogle.->
...
> Applied vendor and board fixes: enabled sdm660 DRM_PP, resolved duplicate board/platform issues, added master-side CP support, refactored GMS client ID logic and dexpreopt'd SystemUIGoogle.->
...
> Backported BoardConfigQcom and vendor tweaks: resolved duplicate platform issues, enabled sdm660 DRM_PP and master-side CP, refactored PRODUCT_GMS_CLIENTID_BASE handling and dexpreopt'd SystemUIGoogle.->
...
> Polished jasmine_sprout device: adjusted branding and screen density to stock values, added battery capacity info, stopped building TWRP, and cleaned build descriptors.->
...
> Kept CI and dependencies current: merged multiple dependabot updates for dotenv, e, faker, Playwright/test and added dependabot configuration.->
...
> Merged maintenance and tooling PRs: added Copilot code-review runner, applied dependabot updates and added dependabot configuration.->
...
> Synced msm8996-common with vendor release: updated carrier, filesystem, security configs and media codecs from LA.UM.9.6.3.->
...
> Improved qcom sepolicy: added c2 rules for legacy devices, adjusted PE sepolicy usage and paths, and removed vendor prefix from lmkd rules.->
...
> Synced hardware interfaces to Android 11: merged multiple android-11.0.0_rXX tags to keep interfaces up to date.->
...
> Switched RMX1801 to an OpenGL rendering backend and removed obsolete graphics properties to simplify rendering configuration.->
...
> Enhanced sdm660-common: built libssrec and tinymix from source, restored telephony injection, and fixed camera interface properties for ViLTE calls.->
...
> Integrated automation and maintenance: added Copilot code-review runner and dependabot configuration.->
...
> Enabled DT2W proximity checks and converted lavender overlays to RRO for cleaner runtime overlay handling.->
...
> Enabled Camera2 API for legacy sm6150 targets and fixed camera interface properties to improve ViLTE behavior.->
...
> Added ViLTE properties and enabled Camera2 API for miatoll, improving legacy camera and telephony compatibility.->
...
> Reordered Bluetooth configuration inheritance to use board configs before product configs and conditionally set telephony advancedscan for legacy platforms.->
...
> Applied device_qcom_common fixes: inherit board BT configs first and conditionally enable telephony advancedscan on legacy platforms.->
...
> Added dependabot configuration to keep SnapWP dependencies and workflows up to date.->
...
> Improved updater UX: switched to a dynamic changelog and applied miscellaneous fixes to stabilize updates.->
